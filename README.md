...
You can create tilesets and tilemaps with it and export them to simple/readable formats. There is also a seamless mode to have the pencil go out on the left and enter at the right.
